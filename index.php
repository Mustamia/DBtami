...
#particles-js{
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header bg-light">
        <h5 class="modal-title">LIST PESANAN CUSTOMER </h5>
  ...
  <?php 
		include 'koneksi.php';
		$no = 1;
		$data = mysqli_query($koneksi,"select * from data_pesanan");
      ...
      <div class="modal-header"><button onclick='change();'  value='show' id='btn1' type="button" class="btn btn-primary">TAMBAH PESANAN</button></a>
  </div>
<br>
